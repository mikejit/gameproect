...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image = pygame.image.load("assets/Play 7eb10a21f253da18c8a7760e275590ad.jpg"), pos=(640,250),
                             text_input="PLAY", font= get_font(75), base_color= "##d7fcd4", hovering_color="White" )
        
        OPTION_BUTTON = Button(image=pygame.image.load("assets/Options 7eb10a21f253da18c8a7760e275590ad.jpg"), pos=(640,400),
                               text_input="OPTIONS", font=get_font(75), base_color="#d7fcd4", hoverinf_color="White")
        SETTINGS_BUTTON = Button(image=pygame.image.load("assets/Settings 7eb10a21f253da18c8a7760e275590ad.jpg"), pos=(640,400),
                               text_input="SETTINGS", font=get_font(75), base_color="#d7fcd4", hoverinf_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/Quit 7eb10a21f253da18c8a7760e275590ad.jpg"), pos=(640,400),
